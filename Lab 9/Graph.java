...
public class Graph<T> {
	...
	void insertEdge(T fromData, T toData, int weight) { // Exercise 3 (Assume that fromData and toData exist in the
		...
		// TODO: add your code here
		//System.out.println(fromAdjList);
	...
	void deleteEdge(T fromData, T toData) { // Exercise 4
		...
		//System.out.println(fromAdjList.firstMember.adjVertex);
		if (fromAdjList.firstMember != null && toData.equals(fromAdjList.firstMember.adjVertex)) {
			// TODO: add your code here
			Member<T> temp = fromAdjList.firstMember.nextMember;
			fromAdjList.firstMember = temp;
			//System.out.println(1);

		} else if (fromAdjList.firstMember != null && !toData.equals(fromAdjList.firstMember.adjVertex)) {
			Member<T> pointer = fromAdjList.firstMember;
			// System.out.println(21);
			while (pointer != null && pointer.nextMember != null) {
				// TODO: add your code here
				if (toData.equals(pointer.nextMember.adjVertex)){
					Member<T> temp = pointer.nextMember;
					pointer.nextMember = temp.nextMember;
					//System.out.println(2);
					break;
				}
				pointer = pointer.nextMember;
			}
		}
		fromAdjList.outdegree--;
		edgeCount--;
	...
	void deleteVertex(T vertex) { // Exercise 5
		...
		while (currentAdjList != null) {
			if (!currentAdjList.data.equals(vertex)) {
				// TODO: add your code here 
				Member<T> pointer = currentAdjList.firstMember;
				while(pointer!=null){
					//System.out.println(pointer.adjVertex);
					if (pointer.adjVertex.equals(vertex)){
						//System.out.println(2);
				...
				if (currentAdjList == firstList) {
					...
					System.out.println("outd"+currentAdjList.outdegree);
